...
describe("TokenBucketAlgorithm", () => {
    ...
    describe("consume()", () => {
        ...
        it("should consume until bucket becomes empty", () => {
            ...
            expect(
                algorithm.getBucketByKey(KEY).tokens
            ).toBe(0);
    ...
    describe("multiple clients", () => {
        ...
        it("should keep buckets isolated", () => {
            ...
            expect(
                algorithm.getBucketByKey(KEY2).tokens
            ).toBe(4);
    ...
    describe("delete()", () => {
        ...
        it("should delete one bucket", () => {
            ...
            expect(
                algorithm.deleteBucketByKey(KEY).deleted
            ).toBe(true);
